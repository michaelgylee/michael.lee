...
- **최신 소스 보호**: 일간/주간 Google News RSS, TreeSoop 최신 게시물, Trend Chaser 최신 브리프를 매 실행 시 새로 조회합니다. 기본 경로가 실패하면 경량 RSS JSON 또는 내장 복구 캐시로 자동 전환해 503/413 오류로 전체 생성이 중단되지 않게 합니다.
